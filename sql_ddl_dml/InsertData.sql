...
-- Đáp án cho Q1
INSERT INTO quiz_answers (question_id,
                          answer_text,
                          is_correct)
VALUES (@Q1Id, N'int', 1),
       (@Q1Id, N'float', 0),
...
INSERT INTO quiz_answers (question_id,
                          answer_text,
                          is_correct)
VALUES (@Q6Id, N'Lấy địa chỉ biến', 1),
...
VALUES (@Lesson5Id, N'Quiz - Câu lệnh if else', 70);
DECLARE @Quiz5Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz5Id, N'Câu lệnh nào dùng để rẽ nhánh trong C?', 'SINGLE', 1, 1);
DECLARE @Q51Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q51Id, N'if else', 1),
       (@Q51Id, N'switch case', 0),
       (@Q51Id, N'for', 0),
       (@Q51Id, N'while', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz5Id, N'Điều kiện trong if thường có kiểu dữ liệu gì?', 'SINGLE', 1, 2);
DECLARE @Q52Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q52Id, N'Boolean', 1),
       (@Q52Id, N'String', 0),
       (@Q52Id, N'Char', 0),
       (@Q52Id, N'Float', 0);
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson6Id, N'Quiz - Câu lệnh switch case', 70);
DECLARE @Quiz6Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz6Id, N'Switch case thường dùng để làm gì?', 'SINGLE', 1, 1);
DECLARE @Q61Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q61Id, N'Chọn một nhánh theo giá trị', 1),
       (@Q61Id, N'Lặp vô hạn', 0),
       (@Q61Id, N'Khai báo biến', 0),
       (@Q61Id, N'Tạo hàm', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz6Id, N'Từ khóa nào dùng để thoát khỏi case?', 'SINGLE', 1, 2);
DECLARE @Q62Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q62Id, N'break', 1),
       (@Q62Id, N'continue', 0),
       (@Q62Id, N'return', 0),
       (@Q62Id, N'exit', 0);
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson7Id, N'Quiz - Vòng lặp for và while', 70);
DECLARE @Quiz7Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz7Id, N'Vòng lặp nào thường biết trước số lần lặp?', 'SINGLE', 1, 1);
DECLARE @Q71Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q71Id, N'for', 1),
       (@Q71Id, N'while', 0),
       (@Q71Id, N'do while', 0),
       (@Q71Id, N'switch', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz7Id, N'Câu lệnh nào kiểm tra điều kiện trước khi lặp?', 'SINGLE', 1, 2);
DECLARE @Q72Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q72Id, N'while', 1),
       (@Q72Id, N'if', 0),
       (@Q72Id, N'switch', 0),
       (@Q72Id, N'goto', 0);
...
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@Section3Id, N'Bài 8 - Khai báo và truy cập mảng', 'Recording%202026-05-28%20212131.mp4', 870, 1, 1,
        'APPROVED');
DECLARE @Lesson8Id INT = SCOPE_IDENTITY();
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson8Id, N'Quiz - Mảng trong C', 70);
DECLARE @Quiz8Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz8Id, N'Chỉ số phần tử đầu tiên của mảng trong C là gì?', 'SINGLE', 1, 1);
DECLARE @Q81Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q81Id, N'0', 1),
       (@Q81Id, N'1', 0),
       (@Q81Id, N'-1', 0),
       (@Q81Id, N'Kích thước mảng', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz8Id, N'Mảng trong C có đặc điểm nào?', 'SINGLE', 1, 2);
DECLARE @Q82Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q82Id, N'Lưu các phần tử cùng kiểu dữ liệu', 1),
       (@Q82Id, N'Lưu mọi kiểu dữ liệu', 0),
       (@Q82Id, N'Không có kích thước', 0),
       (@Q82Id, N'Chỉ lưu chuỗi', 0);
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson9Id, N'Quiz - Duyệt mảng', 70);
DECLARE @Quiz9Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz9Id, N'Vòng lặp nào thường dùng để duyệt mảng?', 'SINGLE', 1, 1);
DECLARE @Q91Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q91Id, N'for', 1),
       (@Q91Id, N'switch', 0),
       (@Q91Id, N'goto', 0),
       (@Q91Id, N'break', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz9Id, N'Độ dài mảng tĩnh trong C được xác định khi nào?', 'SINGLE', 1, 2);
DECLARE @Q92Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q92Id, N'Khi khai báo', 1),
       (@Q92Id, N'Khi chạy chương trình', 0),
       (@Q92Id, N'Khi in ra', 0),
       (@Q92Id, N'Khi kết thúc', 0);
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson10Id, N'Quiz - Xử lý chuỗi', 70);
DECLARE @Quiz10Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz10Id, N'Chuỗi trong C kết thúc bằng ký tự nào?', 'SINGLE', 1, 1);
...
VALUES (@Q101Id, N'\\0', 1),
       ...
       (@Q101Id, N'#', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz10Id, N'Hàm nào thường dùng để đo độ dài chuỗi?', 'SINGLE', 1, 2);
DECLARE @Q102Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q102Id, N'strlen', 1),
       (@Q102Id, N'strcpy', 0),
       (@Q102Id, N'printf', 0),
       (@Q102Id, N'scanf', 0);
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson11Id, N'Quiz - Hàm trong C', 70);
DECLARE @Quiz11Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz11Id, N'Mục đích của hàm trong C là gì?', 'SINGLE', 1, 1);
DECLARE @Q111Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q111Id, N'Tái sử dụng và tổ chức code', 1),
       (@Q111Id, N'Tăng dung lượng RAM', 0),
       (@Q111Id, N'Xóa biến toàn cục', 0),
       (@Q111Id, N'Thay thế vòng lặp', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz11Id, N'Từ khóa nào thường dùng để khai báo hàm trả về số nguyên?', 'SINGLE', 1, 2);
DECLARE @Q112Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q112Id, N'int', 1),
       (@Q112Id, N'void', 0),
       (@Q112Id, N'char', 0),
       (@Q112Id, N'float', 0);

INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@Section4Id, N'Bài 12 - Tham số và giá trị trả về', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1,
        'APPROVED');
DECLARE @Lesson12Id INT = SCOPE_IDENTITY();
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson12Id, N'Quiz - Tham số và giá trị trả về', 70);
DECLARE @Quiz12Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz12Id, N'Tham số hàm được truyền vào khi nào?', 'SINGLE', 1, 1);
DECLARE @Q121Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q121Id, N'Khi gọi hàm', 1),
       (@Q121Id, N'Khi biên dịch', 0),
       (@Q121Id, N'Khi import file', 0),
       (@Q121Id, N'Khi kết thúc hàm', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz12Id, N'Giá trị trả về của hàm được khai báo bằng gì?', 'SINGLE', 1, 2);
DECLARE @Q122Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q122Id, N'Kiểu dữ liệu trả về', 1),
       (@Q122Id, N'Tên hàm', 0),
       (@Q122Id, N'Số tham số', 0),
       (@Q122Id, N'Tên biến cục bộ', 0);
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson13Id, N'Quiz - Con trỏ cơ bản', 70);
DECLARE @Quiz13Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz13Id, N'Con trỏ lưu gì?', 'SINGLE', 1, 1);
DECLARE @Q131Id INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@Q131Id, N'Địa chỉ bộ nhớ', 1),
       (@Q131Id, N'Giá trị chuỗi', 0),
       (@Q131Id, N'Tên biến', 0),
       (@Q131Id, N'Kết quả hàm', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@Quiz13Id, N'Toán tử nào dùng để lấy địa chỉ biến?', 'SINGLE', 1, 2);
...
VALUES (1, 1, 1, '[28Tech] BUOI 1.pdf', '%5B28Tech%5D.%20BUOI%201.pdf', 'pdf', GETDATE()),
...
VALUES (1, 9, N'Lập Trình C Nâng Cao - 28Tech', N'Khóa học nâng cao lập trình C',
        '2aOboQZWp6Ov5iGTAZLOlCgmiOhOKsGgeQU1cI0O.jpg', 350000.00, 'INTERMEDIATE', 'PUBLISHED');
SET @Course2Id = SCOPE_IDENTITY();

-- Sections and lessons for Course 2
DECLARE @C2S1 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course2Id, N'Giới thiệu', 1);
SET @C2S1 = SCOPE_IDENTITY();
DECLARE @C2L1 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S1, N'Bài 1 - Giới thiệu ngôn ngữ C', 'Recording%202026-05-28%20212131.mp4', 600, 1, 1, 'APPROVED');
SET @C2L1 = SCOPE_IDENTITY();
DECLARE @C2L2 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S1, N'Bài 2 - Kiểu dữ liệu và khai báo biến trong C', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1,
        'APPROVED');
SET @C2L2 = SCOPE_IDENTITY();
DECLARE @C2L3 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S1, N'Bài 3 - Xuất dữ liệu với printf', 'Recording%202026-05-28%20212131.mp4', 850, 3, 1, 'APPROVED');
SET @C2L3 = SCOPE_IDENTITY();

-- Seed quizzes for C2 lessons s1
-- For brevity, add one quiz with two simple questions per lesson
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@C2L1, N'Quiz - Giới thiệu', 70);
DECLARE @C2Q1 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@C2Q1, N'Giới thiệu C chủ yếu dùng cho gì?', 'SINGLE', 1, 1);
DECLARE @C2Q11 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@C2Q11, N'Lập trình hệ thống', 1),
       (@C2Q11, N'Trình duyệt', 0),
       (@C2Q11, N'Office', 0),
       (@C2Q11, N'Khác', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@C2Q1, N'C có bước biên dịch hay thông dịch?', 'SINGLE', 1, 2);
DECLARE @C2Q12 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@C2Q12, N'Biên dịch', 1),
       (@C2Q12, N'Thông dịch', 0),
       (@C2Q12, N'Cả hai', 0),
       (@C2Q12, N'Không rõ', 0);

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@C2L2, N'Quiz - Kiểu dữ liệu', 70);
DECLARE @C2Q2 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@C2Q2, N'Kiểu dữ liệu nào lưu số nguyên?', 'SINGLE', 1, 1);
DECLARE @C2Q21 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@C2Q21, N'int', 1),
       (@C2Q21, N'float', 0),
       (@C2Q21, N'double', 0),
       (@C2Q21, N'char', 0);
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@C2Q2, N'Kiểu để lưu ký tự?', 'SINGLE', 1, 2);
DECLARE @C2Q22 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@C2Q22, N'char', 1),
       (@C2Q22, N'string', 0),
       (@C2Q22, N'int', 0),
       (@C2Q22, N'float', 0);

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@C2L3, N'Quiz - printf', 70);
DECLARE @C2Q3 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@C2Q3, N'Hàm printf dùng để?', 'SINGLE', 1, 1);
DECLARE @C2Q31 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@C2Q31, N'Xuất dữ liệu', 1),
       (@C2Q31, N'Nhập dữ liệu', 0),
       (@C2Q31, N'Thực thi', 0),
       (@C2Q31, N'Khác', 0);
...
DECLARE @C2S2 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course2Id, N'Cấu trúc điều khiển', 2);
SET @C2S2 = SCOPE_IDENTITY();
DECLARE @C2S3 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course2Id, N'Mảng và chuỗi', 3);
SET @C2S3 = SCOPE_IDENTITY();
DECLARE @C2S4 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course2Id, N'Hàm và con trỏ', 4);
SET @C2S4 = SCOPE_IDENTITY();

-- For each of these sections, insert 3 lessons and a quiz (use same video file)
-- Section 2 lessons
DECLARE @c2l4 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S2, N'Bài 5 - Câu lệnh if else', 'Recording%202026-05-28%20212131.mp4', 780, 1, 1, 'APPROVED');
SET @c2l4 = SCOPE_IDENTITY();
DECLARE @c2l5 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S2, N'Bài 6 - Câu lệnh switch case', 'Recording%202026-05-28%20212131.mp4', 840, 2, 1, 'APPROVED');
SET @c2l5 = SCOPE_IDENTITY();
DECLARE @c2l6 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S2, N'Bài 7 - Vòng lặp for và while', 'Recording%202026-05-28%20212131.mp4', 900, 3, 1, 'APPROVED');
SET @c2l6 = SCOPE_IDENTITY();

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l4, N'Quiz - If else', 70);
DECLARE @c2q4 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2q4, N'If else để làm gì?', 'SINGLE', 1, 1);
DECLARE @c2q41 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q41, N'Rẽ nhánh', 1),
       (@c2q41, N'Lặp', 0),
       (@c2q41, N'Khai báo', 0),
       (@c2q41, N'Khác', 0);

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l5, N'Quiz - Switch', 70);
DECLARE @c2q5 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2q5, N'Switch dùng để?', 'SINGLE', 1, 1);
DECLARE @c2q51 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q51, N'Chọn nhánh theo giá trị', 1),
       (@c2q51, N'Lặp', 0),
       (@c2q51, N'Khai báo', 0),
       (@c2q51, N'Khác', 0);

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l6, N'Quiz - Vòng lặp', 70);
DECLARE @c2q6 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2q6, N'Vòng lặp for dùng khi?', 'SINGLE', 1, 1);
DECLARE @c2q61 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q61, N'Biết trước số lần lặp', 1),
       (@c2q61, N'Không biết trước', 0),
       (@c2q61, N'Khai báo', 0),
       (@c2q61, N'Khác', 0);
...
DECLARE @c2l7 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S3, N'Bài 8 - Khai báo mảng', 'Recording%202026-05-28%20212131.mp4', 870, 1, 1, 'APPROVED');
SET @c2l7 = SCOPE_IDENTITY();
DECLARE @c2l8 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S3, N'Bài 9 - Duyệt mảng', 'Recording%202026-05-28%20212131.mp4', 930, 2, 1, 'APPROVED');
SET @c2l8 = SCOPE_IDENTITY();
DECLARE @c2l9 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S3, N'Bài 10 - Chuỗi', 'Recording%202026-05-28%20212131.mp4', 960, 3, 1, 'APPROVED');
SET @c2l9 = SCOPE_IDENTITY();

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l7, N'Quiz - Mảng', 70);
DECLARE @c2q7 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2q7, N'Chỉ số bắt đầu của mảng?', 'SINGLE', 1, 1);
DECLARE @c2q71 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q71, N'0', 1),
       (@c2q71, N'1', 0),
       (@c2q71, N'-1', 0),
...
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l8, N'Quiz - Duyệt mảng', 70);
DECLARE @c2q8 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2q8, N'Vòng lặp hay dùng để duyệt mảng?', 'SINGLE', 1, 1);
DECLARE @c2q81 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q81, N'for', 1),
       (@c2q81, N'while', 0),
       (@c2q81, N'switch', 0),
       (@c2q81, N'Khác', 0);

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l9, N'Quiz - Chuỗi', 70);
DECLARE @c2q9 INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2q9, N'Chuỗi kết thúc bằng gì?', 'SINGLE', 1, 1);
DECLARE @c2q91 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q91, N'\0', 1),
       (@c2q91, N'\n', 0),
       (@c2q91, N'space', 0),
...
DECLARE @c2l10 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S4, N'Bài 11 - Hàm', 'Recording%202026-05-28%20212131.mp4', 840, 1, 1, 'APPROVED');
SET @c2l10 = SCOPE_IDENTITY();
DECLARE @c2l11 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S4, N'Bài 12 - Tham số', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1, 'APPROVED');
SET @c2l11 = SCOPE_IDENTITY();
DECLARE @c2l12 INT;
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C2S4, N'Bài 13 - Con trỏ', 'Recording%202026-05-28%20212131.mp4', 980, 3, 1, 'APPROVED');
SET @c2l12 = SCOPE_IDENTITY();

INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@c2l12, N'Quiz - Con trỏ', 70);
DECLARE @c2_l12_quiz INT = SCOPE_IDENTITY();
INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
VALUES (@c2_l12_quiz, N'Con trỏ lưu gì?', 'SINGLE', 1, 1);
DECLARE @c2q121 INT = SCOPE_IDENTITY();
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@c2q121, N'Địa chỉ bộ nhớ', 1),
       (@c2q121, N'Giá trị', 0),
       (@c2q121, N'Tên biến', 0),
       (@c2q121, N'Khác', 0);
...
INSERT INTO courses (instructor_id, category_id, title, description, thumbnail_url, price, level, status)
VALUES (1, 9, N'Lập Trình C Thực Hành - 28Tech', N'Bài tập thực hành và project nhỏ với C',
        '2aOboQZWp6Ov5iGTAZLOlCgmiOhOKsGgeQU1cI0O.jpg', 600000.00, 'BEGINNER', 'PUBLISHED');
...
DECLARE @C3S1 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course3Id, N'Giới thiệu', 1);
SET @C3S1 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S1, N'Bài 1 - Giới thiệu', 'Recording%202026-05-28%20212131.mp4', 600, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S1, N'Bài 2 - Kiểu dữ liệu', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S1, N'Bài 3 - printf', 'Recording%202026-05-28%20212131.mp4', 850, 3, 1, 'APPROVED');
DECLARE @C3S2 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course3Id, N'Cấu trúc điều khiển', 2);
SET @C3S2 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S2, N'Bài 4', 'Recording%202026-05-28%20212131.mp4', 780, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S2, N'Bài 5', 'Recording%202026-05-28%20212131.mp4', 840, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S2, N'Bài 6', 'Recording%202026-05-28%20212131.mp4', 900, 3, 1, 'APPROVED');
DECLARE @C3S3 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course3Id, N'Mảng và chuỗi', 3);
SET @C3S3 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S3, N'Bài 7', 'Recording%202026-05-28%20212131.mp4', 870, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S3, N'Bài 8', 'Recording%202026-05-28%20212131.mp4', 930, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S3, N'Bài 9', 'Recording%202026-05-28%20212131.mp4', 960, 3, 1, 'APPROVED');
DECLARE @C3S4 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course3Id, N'Hàm và con trỏ', 4);
SET @C3S4 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S4, N'Bài 10', 'Recording%202026-05-28%20212131.mp4', 840, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S4, N'Bài 11', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C3S4, N'Bài 12', 'Recording%202026-05-28%20212131.mp4', 980, 3, 1, 'APPROVED');

INSERT INTO lesson_materials (instructor_id, course_id, lesson_id, file_name, file_url, file_type, created_at)
VALUES (1, @Course3Id, (SELECT TOP 1 id FROM lessons WHERE section_id = @C3S4 ORDER BY position DESC),
        N'[28Tech] COURSE3_LESSON.pdf', '%5BCOURSE3%5D.%20LESSON.pdf', 'pdf', GETDATE());

-- COURSE 4 (mirror structure)
DECLARE @Course4Id INT;
INSERT INTO courses (instructor_id, category_id, title, description, thumbnail_url, price, level, status)
VALUES (1, 1, N'Thuật Toán C với 28Tech', N'Giải thuật và cấu trúc dữ liệu cơ bản bằng C',
        '2aOboQZWp6Ov5iGTAZLOlCgmiOhOKsGgeQU1cI0O.jpg', 0, 'ADVANCED', 'PUBLISHED');
SET @Course4Id = SCOPE_IDENTITY();

-- create four sections and three lessons each using same recording
DECLARE @C4S1 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course4Id, N'Giới thiệu', 1);
SET @C4S1 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S1, N'Bài 1', 'Recording%202026-05-28%20212131.mp4', 600, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S1, N'Bài 2', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S1, N'Bài 3', 'Recording%202026-05-28%20212131.mp4', 850, 3, 1, 'APPROVED');
DECLARE @C4S2 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course4Id, N'Cơ sở giải thuật', 2);
SET @C4S2 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S2, N'Bài 4', 'Recording%202026-05-28%20212131.mp4', 780, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S2, N'Bài 5', 'Recording%202026-05-28%20212131.mp4', 840, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S2, N'Bài 6', 'Recording%202026-05-28%20212131.mp4', 900, 3, 1, 'APPROVED');
DECLARE @C4S3 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course4Id, N'Cấu trúc dữ liệu', 3);
SET @C4S3 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S3, N'Bài 7', 'Recording%202026-05-28%20212131.mp4', 870, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S3, N'Bài 8', 'Recording%202026-05-28%20212131.mp4', 930, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S3, N'Bài 9', 'Recording%202026-05-28%20212131.mp4', 960, 3, 1, 'APPROVED');
DECLARE @C4S4 INT;
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course4Id, N'Hàm và tối ưu', 4);
SET @C4S4 = SCOPE_IDENTITY();
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S4, N'Bài 10', 'Recording%202026-05-28%20212131.mp4', 840, 1, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S4, N'Bài 11', 'Recording%202026-05-28%20212131.mp4', 900, 2, 1, 'APPROVED');
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@C4S4, N'Bài 12', 'Recording%202026-05-28%20212131.mp4', 980, 3, 1, 'APPROVED');

INSERT INTO lesson_materials (instructor_id, course_id, lesson_id, file_name, file_url, file_type, created_at)
VALUES (1, @Course4Id, (SELECT TOP 1 id FROM lessons WHERE section_id = @C4S4 ORDER BY position DESC),
        N'[28Tech] COURSE4_LESSON.pdf', '%5BCOURSE4%5D.%20LESSON.pdf', 'pdf', GETDATE());
            ...
            BEGIN
                ...
                WHILE @LessonPos <= 3
                    BEGIN
                        ...
                        INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published,
                                             moderation_status)
                        VALUES (@SectionId,
                        ...
                        INSERT INTO quiz_questions (quiz_id, question_text, question_type, points, position)
                        VALUES (@QuizId, CONCAT(N'Khóa học chuyên đề số mấy? (Bài ', @LessonGlobalPos, N')'), 'SINGLE',
                                1, 2);
...
(first_name,
 ...
 password_hash,
 status)
VALUES (N'Nguyễn Văn', N'An', 'nguyenvanan@gmail.com', '0900000001', '12345678', 'ACTIVE'),
...
(user_id,
 ...
 status,
 reviewed_by)
VALUES (1, 'https://blob/cv1.pdf', 'https://blob/cert1.pdf', N'5 năm kinh nghiệm Java Backend', 'APPROVED', 11),
...
IF NOT EXISTS (SELECT 1
               FROM users
               WHERE email = 'dothanh2572005@gmail.com')
    BEGIN
...
INSERT INTO courses (instructor_id, category_id, title, description, thumbnail_url, price, level, status, approved_by,
                     approved_at)
VALUES (1, 1, N'Cấu Trúc Dữ Liệu Và Giải Thuật - 28Tech',
        N'Khóa học cung cấp kiến thức nền tảng về Cấu trúc dữ liệu và Giải thuật sử dụng C/C++.', 'dsa-28tech.jpg',
        500000.00, 'INTERMEDIATE', 'PUBLISHED', 3, GETDATE()),
       (1, 1, N'Lập Trình Java Web với Spring Boot',
        N'Khóa học Java Web toàn diện từ Zero đến Hero với Spring Boot, Spring Security, JPA, và Azure.',
        'spring-boot.jpg', 1200000.00, 'ADVANCED', 'PUBLISHED', 3, GETDATE());

DECLARE @Course2Id INT = (SELECT id
                          FROM courses
                          WHERE title = N'Cấu Trúc Dữ Liệu Và Giải Thuật - 28Tech');
DECLARE @Course3Id INT = (SELECT id
                          FROM courses
                          WHERE title = N'Lập Trình Java Web với Spring Boot');

-- 2. Insert sections for Course 2 & 3
INSERT INTO course_sections (course_id, title, position)
VALUES (@Course2Id, N'Chương 1: Các cấu trúc dữ liệu cơ bản', 1),
       (@Course3Id, N'Chương 1: Khởi đầu với Spring Boot', 1);

DECLARE @Section2Id INT = (SELECT id
                           FROM course_sections
                           WHERE course_id = @Course2Id
                             AND title = N'Chương 1: Các cấu trúc dữ liệu cơ bản');
DECLARE @Section3Id INT = (SELECT id
                           FROM course_sections
                           WHERE course_id = @Course3Id
                             AND title = N'Chương 1: Khởi đầu với Spring Boot');

-- 3. Insert lessons for Course 2 & 3
INSERT INTO lessons (section_id, title, video_url, duration_seconds, position, is_published, moderation_status)
VALUES (@Section2Id, N'Bài 1 - Mảng động và Danh sách liên kết', 'videos/dsa_array_linkedlist.mp4', 800, 1, 1,
        'APPROVED'),
       (@Section2Id, N'Bài 2 - Ngăn xếp (Stack) và Hàng đợi (Queue)', 'videos/dsa_stack_queue.mp4', 900, 2, 1,
        'APPROVED'),
       (@Section3Id, N'Bài 1 - Giới thiệu Spring Framework và Spring Boot', 'videos/spring_intro.mp4', 1000, 1, 1,
        'APPROVED'),
       (@Section3Id, N'Bài 2 - Hướng dẫn cấu hình môi trường Spring Boot', 'videos/spring_setup.mp4', 1200, 2, 1,
        'APPROVED');

DECLARE @Lesson5Id INT = (SELECT id
                          FROM lessons
                          WHERE title = N'Bài 1 - Mảng động và Danh sách liên kết');
DECLARE @Lesson6Id INT = (SELECT id
                          FROM lessons
                          WHERE title = N'Bài 2 - Ngăn xếp (Stack) và Hàng đợi (Queue)');
DECLARE @Lesson7Id INT = (SELECT id
                          FROM lessons
                          WHERE title = N'Bài 1 - Giới thiệu Spring Framework và Spring Boot');
DECLARE @Lesson8Id INT = (SELECT id
                          FROM lessons
                          WHERE title = N'Bài 2 - Hướng dẫn cấu hình môi trường Spring Boot');

-- 4. Insert quizzes for Course 2 & 3
INSERT INTO quizzes (lesson_id, title, pass_score_percent)
VALUES (@Lesson6Id, N'Quiz - Stack và Queue', 70),
       (@Lesson8Id, N'Quiz - Tổng quan Spring Boot', 70);

DECLARE @QuizDSAId INT = (SELECT id
                          FROM quizzes
                          WHERE title = N'Quiz - Stack và Queue');
DECLARE @QuizSpringId INT = (SELECT id
                             FROM quizzes
                             WHERE title = N'Quiz - Tổng quan Spring Boot');
...
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@QDSAQ1Id, N'LIFO (Last In First Out)', 1),
...
INSERT INTO quiz_answers (question_id, answer_text, is_correct)
VALUES (@QSpringQ1Id, N'Cấu hình và triển khai ứng dụng (Auto-configuration)', 1),
...
VALUES (1, 'WELCOME10', 'PERCENT', 10.00, 100, 1, DATEADD(month, 6, GETDATE()), 'ACTIVE'),
       (1, 'DEVSPECIAL', 'FIXED', 100000.00, 50, 0, DATEADD(month, 3, GETDATE()), 'ACTIVE');

DECLARE @Coupon1Id INT = (SELECT id
                          FROM coupons
...
DECLARE @L1Id INT = (SELECT TOP 1 l.id
                     FROM lessons l
                              JOIN course_sections s ON l.section_id = s.id
                              JOIN courses c ON s.course_id = c.id
                     WHERE l.title = N'Bài 1 - Giới thiệu ngôn ngữ C'
                       AND c.title = N'Lập Trình C Cơ Bản - 28Tech');
DECLARE @L2Id INT = (SELECT TOP 1 l.id
                     FROM lessons l
                              JOIN course_sections s ON l.section_id = s.id
                              JOIN courses c ON s.course_id = c.id
                     WHERE l.title = N'Bài 2 - Kiểu dữ liệu và khai báo biến trong C'
                       AND c.title = N'Lập Trình C Cơ Bản - 28Tech');
DECLARE @L3Id INT = (SELECT TOP 1 l.id
                     FROM lessons l
                              JOIN course_sections s ON l.section_id = s.id
                              JOIN courses c ON s.course_id = c.id
                     WHERE l.title = N'Bài 3 - Xuất dữ liệu với printf'
                       AND c.title = N'Lập Trình C Cơ Bản - 28Tech');
DECLARE @L4Id INT = (SELECT TOP 1 l.id
                     FROM lessons l
                              JOIN course_sections s ON l.section_id = s.id
                              JOIN courses c ON s.course_id = c.id
                     WHERE l.title = N'Bài 4 - Nhập dữ liệu với scanf'
                       AND c.title = N'Lập Trình C Cơ Bản - 28Tech');

DECLARE @Qz2Id INT = (SELECT TOP 1 q.id
                      FROM quizzes q
                               JOIN lessons l ON q.lesson_id = l.id
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE q.title = N'Quiz - Kiểu dữ liệu và biến'
                        AND c.title = N'Lập Trình C Cơ Bản - 28Tech');
DECLARE @Qz3Id INT = (SELECT TOP 1 q.id
                      FROM quizzes q
                               JOIN lessons l ON q.lesson_id = l.id
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE q.title = N'Quiz - Hàm printf'
                        AND c.title = N'Lập Trình C Cơ Bản - 28Tech');
DECLARE @Qz4Id INT = (SELECT TOP 1 q.id
                      FROM quizzes q
                               JOIN lessons l ON q.lesson_id = l.id
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE q.title = N'Quiz - Hàm scanf'
                        AND c.title = N'Lập Trình C Cơ Bản - 28Tech');

DECLARE @C1Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Lập Trình C Cơ Bản - 28Tech');
DECLARE @C2Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Lập Trình C Nâng Cao - 28Tech');
DECLARE @C3Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Lập Trình C Thực Hành - 28Tech');
DECLARE @C4Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Thuật Toán C với 28Tech');
DECLARE @C5Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Lập Trình Python Cơ Bản và Nâng Cao');
DECLARE @C6Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Xây Dựng Giao Diện Web Với HTML5');
DECLARE @C7Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Làm Chủ CSS Grid Và Flexbox Responsive');
DECLARE @C8Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Lập Trình Frontend Hiện Đại Với ReactJS');
DECLARE @C9Id INT = (SELECT id
                     FROM courses
                     WHERE title = N'Xây Dựng RESTful API Với Node.js');
DECLARE @C10Id INT = (SELECT id
                      FROM courses
                      WHERE title = N'Lập Trình Ứng Dụng iOS Với Ngôn Ngữ Swift');
DECLARE @C11Id INT = (SELECT id
                      FROM courses
                      WHERE title = N'Thiết Kế Giao Diện iOS Bằng SwiftUI');
DECLARE @C12Id INT = (SELECT id
                      FROM courses
                      WHERE title = N'Lập Trình Hướng Đối Tượng Java Core');
DECLARE @C13Id INT = (SELECT id
                      FROM courses
                      WHERE title = N'Phát Triển Ứng Dụng Web Với Java Spring Boot');
DECLARE @C14Id INT = (SELECT id
                      FROM courses
                      WHERE title = N'Lập Trình C Chuyên Đề 14 - 28Tech');

-- Lesson IDs for Course 2 (C Nâng cao) Section 1 (Giới thiệu)
DECLARE @C2_L1 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 1 - Giới thiệu ngôn ngữ C'
                        AND c.title = N'Lập Trình C Nâng Cao - 28Tech');
DECLARE @C2_L2 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 2 - Kiểu dữ liệu và khai báo biến trong C'
                        AND c.title = N'Lập Trình C Nâng Cao - 28Tech');
DECLARE @C2_L3 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 3 - Xuất dữ liệu với printf'
...
DECLARE @C3_L1 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 1 - Giới thiệu'
                        AND c.title = N'Lập Trình C Thực Hành - 28Tech');
DECLARE @C3_L2 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 2 - Kiểu dữ liệu'
                        AND c.title = N'Lập Trình C Thực Hành - 28Tech');
DECLARE @C3_L3 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 3 - printf'
                        AND c.title = N'Lập Trình C Thực Hành - 28Tech');

-- Lesson IDs for Course 4 Section 1 (Giới thiệu)
DECLARE @C4_L1 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 1'
                        AND c.title = N'Thuật Toán C với 28Tech');

-- Lesson IDs for Course 5 Section 1 (Giới thiệu)
DECLARE @C5_L1 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 1 - Chuyên đề 5'
                        AND c.title = N'Lập Trình Python Cơ Bản và Nâng Cao');
DECLARE @C5_L2 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 2 - Chuyên đề 5'
                        AND c.title = N'Lập Trình Python Cơ Bản và Nâng Cao');
DECLARE @C5_L3 INT = (SELECT l.id
                      FROM lessons l
                               JOIN course_sections s ON l.section_id = s.id
                               JOIN courses c ON s.course_id = c.id
                      WHERE l.title = N'Bài 3 - Chuyên đề 5'
                        AND c.title = N'Lập Trình Python Cơ Bản và Nâng Cao');
...
DECLARE @C3_Qz2Id INT = (SELECT q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Kiểu dữ liệu và biến'
                           AND c.title = N'Lập Trình C Thực Hành - 28Tech');
DECLARE @C3_Qz3Id INT = (SELECT q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Hàm printf'
                           AND c.title = N'Lập Trình C Thực Hành - 28Tech');
DECLARE @C3_Qz4Id INT = (SELECT q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
...
DECLARE @C4_Qz2Id INT = (SELECT TOP 1 q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Kiểu dữ liệu và biến'
                           AND c.title = N'Thuật Toán C với 28Tech');
DECLARE @C4_Qz3Id INT = (SELECT TOP 1 q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Hàm printf'
                           AND c.title = N'Thuật Toán C với 28Tech');
DECLARE @C4_Qz4Id INT = (SELECT TOP 1 q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
...
DECLARE @C5_Qz1Id INT = (SELECT TOP 1 q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Bài 1 - Khóa 5'
                           AND c.title = N'Lập Trình Python Cơ Bản và Nâng Cao');
DECLARE @C5_Qz2Id INT = (SELECT TOP 1 q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Bài 2 - Khóa 5'
                           AND c.title = N'Lập Trình Python Cơ Bản và Nâng Cao');
DECLARE @C5_Qz3Id INT = (SELECT TOP 1 q.id
                         FROM quizzes q
                                  JOIN lessons l ON q.lesson_id = l.id
                                  JOIN course_sections s ON l.section_id = s.id
                                  JOIN courses c ON s.course_id = c.id
                         WHERE q.title = N'Quiz - Bài 3 - Khóa 5'
                           AND c.title = N'Lập Trình Python Cơ Bản và Nâng Cao');

-- Coupons already inserted in previous batch (lines ~1978-1981), just read their IDs
DECLARE @Cp1Id INT = (SELECT id
                      FROM coupons
                      WHERE code = 'WELCOME10');
DECLARE @Cp2Id INT = (SELECT id
                      FROM coupons
                      WHERE code = 'DEVSPECIAL');

-- B. INSERT USERS (LEARNERS)
INSERT INTO users (first_name, last_name, email, phone, password_hash, avatar_url, google_id, status)
VALUES (N'Nguyễn Văn', N'An', 'an.nguyen@elearning.com', '0981112222', 'password123', 'avatars/an_nguyen.jpg', NULL,
        'ACTIVE'),
       (N'Trần Thị', N'Bình', 'binh.tran@elearning.com', '0982223333', 'password123', 'avatars/binh_tran.jpg', NULL,
        'ACTIVE'),
       (N'Phạm Văn', N'Cường', 'cuong.pham@elearning.com', '0983334444', 'password123', 'avatars/cuong_pham.jpg', NULL,
        'ACTIVE'),
       (N'Hoàng Thị', N'Dung', 'dung.hoang@elearning.com', '0984445555', NULL, 'avatars/dung_hoang.jpg',
        'google_1029384756', 'ACTIVE'),
       (N'Đỗ Văn', N'Em', 'em.do@elearning.com', '0985556666', 'password123', 'avatars/em_do.jpg', NULL, 'ACTIVE'),
       (N'Lê Thu', N'Giang', 'giang.le@elearning.com', '0986667777', 'password123', 'avatars/giang_le.jpg', NULL,
        'ACTIVE'),
       ...
       (N'Bùi Anh', N'Khoa', 'khoa.bui@elearning.com', '0989990000', 'password123', 'avatars/khoa_bui.jpg', NULL,
        'ACTIVE'),
       (N'Đặng Quang', N'Long', 'long.dang@elearning.com', '0980001111', 'password123', 'avatars/long_dang.jpg', NULL,
        'ACTIVE');

DECLARE @UserAnId INT = (SELECT id
                         FROM users
                         WHERE email = 'an.nguyen@elearning.com');
DECLARE @UserBinhId INT = (SELECT id
                           FROM users
                           WHERE email = 'binh.tran@elearning.com');
DECLARE @UserCuongId INT = (SELECT id
                            FROM users
                            WHERE email = 'cuong.pham@elearning.com');
DECLARE @UserDungId INT = (SELECT id
                           FROM users
                           WHERE email = 'dung.hoang@elearning.com');
DECLARE @UserEmId INT = (SELECT id
                         FROM users
                         WHERE email = 'em.do@elearning.com');
DECLARE @UserGiangId INT = (SELECT id
                            FROM users
                            WHERE email = 'giang.le@elearning.com');
DECLARE @UserHaiId INT = (SELECT id
                          FROM users
                          WHERE email = 'hai.vu@elearning.com');
DECLARE @UserHuyId INT = (SELECT id
                          FROM users
                          WHERE email = 'huy.do@elearning.com');
DECLARE @UserKhoaId INT = (SELECT id
                           FROM users
                           WHERE email = 'khoa.bui@elearning.com');
DECLARE @UserLongId INT = (SELECT id
                           FROM users
                           WHERE email = 'long.dang@elearning.com');
...
DECLARE @CartAnId INT = (SELECT id
                         FROM carts
                         WHERE user_id = @UserAnId);
DECLARE @CartBinhId INT = (SELECT id
                           FROM carts
                           WHERE user_id = @UserBinhId);
DECLARE @CartCuongId INT = (SELECT id
                            FROM carts
                            WHERE user_id = @UserCuongId);
DECLARE @CartDungId INT = (SELECT id
                           FROM carts
                           WHERE user_id = @UserDungId);
DECLARE @CartEmId INT = (SELECT id
                         FROM carts
                         WHERE user_id = @UserEmId);
DECLARE @CartGiangId INT = (SELECT id
                            FROM carts
                            WHERE user_id = @UserGiangId);
DECLARE @CartHaiId INT = (SELECT id
                          FROM carts
                          WHERE user_id = @UserHaiId);
DECLARE @CartHuyId INT = (SELECT id
                          FROM carts
                          WHERE user_id = @UserHuyId);
DECLARE @CartKhoaId INT = (SELECT id
                           FROM carts
                           WHERE user_id = @UserKhoaId);
DECLARE @CartLongId INT = (SELECT id
                           FROM carts
                           WHERE user_id = @UserLongId);

-- D. INSERT ACTIVE CART ITEMS
-- Binh has Course 3 (C Thực Hành) in cart
INSERT INTO cart_items (cart_id, course_id)
VALUES (@CartBinhId, @C3Id);
-- Dung has Course 2 (C Nâng Cao) in cart
INSERT INTO cart_items (cart_id, course_id)
VALUES (@CartDungId, @C2Id);
-- Giang has Course 1 (C Cơ Bản) in cart
INSERT INTO cart_items (cart_id, course_id)
VALUES (@CartGiangId, @C1Id);
-- Huy has Course 1 and Course 4 in cart
INSERT INTO cart_items (cart_id, course_id)
VALUES (@CartHuyId, @C1Id),
       (@CartHuyId, @C4Id);
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderAnId, @C1Id, NULL, 0.00, 0.00, 0.00, N'Lập Trình C Cơ Bản - 28Tech', DATEADD(day, -5, GETDATE())),
       (@OrderAnId, @C2Id, NULL, 350000.00, 0.00, 350000.00, N'Lập Trình C Nâng Cao - 28Tech',
        DATEADD(day, -5, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderAnId, 'TX_AN_001', 'MOMO', 'GATEWAY_8837', 350000.00, 'SUCCESS', DATEADD(day, -5, GETDATE()),
        DATEADD(day, -5, GETDATE()));
...
INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderBinhId, 'TX_BINH_001', 'VNPAY', 'GATEWAY_2283', 0.00, 'SUCCESS', DATEADD(day, -4, GETDATE()),
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderCuongId, @C2Id, @Cp1Id, 350000.00, 50000.00, 300000.00, N'Lập Trình C Nâng Cao - 28Tech',
        DATEADD(day, -3, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderCuongId, 'TX_CUONG_001', 'CARD', 'GATEWAY_9948', 300000.00, 'SUCCESS', DATEADD(day, -3, GETDATE()),
        DATEADD(day, -3, GETDATE()));
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderDungId, @C3Id, NULL, 600000.00, 0.00, 600000.00, N'Lập Trình C Thực Hành - 28Tech',
        DATEADD(day, -2, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderDungId, 'TX_DUNG_001', 'MOMO', 'GATEWAY_7749', 600000.00, 'SUCCESS', DATEADD(day, -2, GETDATE()),
        DATEADD(day, -2, GETDATE()));
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderEmId, @C1Id, NULL, 0.00, 0.00, 0.00, N'Lập Trình C Cơ Bản - 28Tech', DATEADD(day, -1, GETDATE())),
       (@OrderEmId, @C3Id, NULL, 600000.00, 0.00, 600000.00, N'Lập Trình C Thực Hành - 28Tech',
        DATEADD(day, -1, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderEmId, 'TX_EM_001', 'VNPAY', 'GATEWAY_5539', 600000.00, 'SUCCESS', DATEADD(day, -1, GETDATE()),
        DATEADD(day, -1, GETDATE()));
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderGiangId, @C2Id, NULL, 350000.00, 0.00, 350000.00, N'Lập Trình C Nâng Cao - 28Tech',
        DATEADD(day, -1, GETDATE()));
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderHaiId, @C4Id, @Cp2Id, 850000.00, 100000.00, 750000.00, N'Thuật Toán C với 28Tech',
        DATEADD(day, -1, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderHaiId, 'TX_HAI_001', 'BANK_TRANSFER', 'GATEWAY_4439', 750000.00, 'SUCCESS', DATEADD(day, -1, GETDATE()),
        DATEADD(day, -1, GETDATE()));
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderKhoaId, @C5Id, @Cp1Id, 1500000.00, 0.00, 1500000.00, N'Lập Trình Python Cơ Bản và Nâng Cao',
        DATEADD(day, -1, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderKhoaId, 'TX_KHOA_001', 'MOMO', 'GATEWAY_3329', 1500000.00, 'SUCCESS', DATEADD(day, -1, GETDATE()),
        DATEADD(day, -1, GETDATE()));
...
INSERT INTO order_items (order_id, course_id, coupon_id, price_snapshot, discount_amount, final_price,
                         course_title_snapshot, created_at)
VALUES (@OrderLongId, @C1Id, NULL, 0.00, 0.00, 0.00, N'Lập Trình C Cơ Bản - 28Tech', DATEADD(day, -1, GETDATE())),
       (@OrderLongId, @C5Id, NULL, 1500000.00, 0.00, 1500000.00, N'Lập Trình Python Cơ Bản và Nâng Cao',
        DATEADD(day, -1, GETDATE()));

INSERT INTO payments (order_id, transaction_code, gateway, gateway_tx_id, amount, status, paid_at, created_at)
VALUES (@OrderLongId, 'TX_LONG_001', 'VNPAY', 'GATEWAY_9938', 1500000.00, 'SUCCESS', DATEADD(day, -1, GETDATE()),
        DATEADD(day, -1, GETDATE()));
...
VALUES (@UserAnId, @C1Id, 100.00, DATEADD(day, -5, GETDATE()), DATEADD(day, -3, GETDATE())),
       (@UserAnId, @C2Id, 50.00, DATEADD(day, -5, GETDATE()), NULL);

DECLARE @EnrollAnC2 INT = (SELECT id
                           FROM enrollments
                           WHERE user_id = @UserAnId
                             AND course_id = @C2Id);
...
VALUES ((SELECT id FROM enrollments WHERE user_id = @UserAnId AND course_id = @C1Id), @L1Id, 1,
        DATEADD(day, -5, GETDATE())),
       ((SELECT id FROM enrollments WHERE user_id = @UserAnId AND course_id = @C1Id), @L2Id, 1,
        DATEADD(day, -4, GETDATE())),
       ((SELECT id FROM enrollments WHERE user_id = @UserAnId AND course_id = @C1Id), @L3Id, 1,
        DATEADD(day, -4, GETDATE())),
       ((SELECT id FROM enrollments WHERE user_id = @UserAnId AND course_id = @C1Id), @L4Id, 1,
        DATEADD(day, -3, GETDATE()));

-- Course 1 Quiz Attempts
INSERT INTO quiz_attempts (user_id, quiz_id, score, is_passed, started_at, submitted_at)
VALUES (@UserAnId, @Qz2Id, 100.00, 1, DATEADD(day, -4, GETDATE()), DATEADD(day, -4, GETDATE())),
...
DECLARE @EnrollBinhC1 INT = (SELECT id
                             FROM enrollments
                             WHERE user_id = @UserBinhId
                               AND course_id = @C1Id);
...
INSERT INTO lesson_progress (enrollment_id, lesson_id, is_completed, last_accessed)
VALUES (@EnrollBinhC1, @L1Id, 1, DATEADD(day, -4, GETDATE())),
...
DECLARE @EnrollDungC3 INT = (SELECT id
                             FROM enrollments
                             WHERE user_id = @UserDungId
                               AND course_id = @C3Id);
...
INSERT INTO lesson_progress (enrollment_id, lesson_id, is_completed, last_accessed)
VALUES (@EnrollDungC3, @C3_L1, 1, DATEADD(day, -2, GETDATE())),
       (@EnrollDungC3, @C3_L2, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollDungC3, @C3_L3, 1, DATEADD(day, -1, GETDATE()));

-- Course 3 Quiz Attempts
INSERT INTO quiz_attempts (user_id, quiz_id, score, is_passed, started_at, submitted_at)
VALUES (@UserDungId, @C3_Qz2Id, 100.00, 1, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE())),
...
INSERT INTO enrollments (user_id, course_id, progress_percent, created_at, completed_at)
VALUES (@UserEmId, @C1Id, 75.00, DATEADD(day, -1, GETDATE()), NULL),
       (@UserEmId, @C3Id, 50.00, DATEADD(day, -1, GETDATE()), NULL);

DECLARE @EnrollEmC1 INT = (SELECT id
                           FROM enrollments
                           WHERE user_id = @UserEmId
                             AND course_id = @C1Id);
DECLARE @EnrollEmC3 INT = (SELECT id
                           FROM enrollments
                           WHERE user_id = @UserEmId
                             AND course_id = @C3Id);
...
INSERT INTO lesson_progress (enrollment_id, lesson_id, is_completed, last_accessed)
VALUES (@EnrollEmC1, @L1Id, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollEmC1, @L2Id, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollEmC1, @L3Id, 1, DATEADD(day, -1, GETDATE()));

-- Course 1 Quiz Attempts
INSERT INTO quiz_attempts (user_id, quiz_id, score, is_passed, started_at, submitted_at)
VALUES (@UserEmId, @Qz2Id, 85.00, 1, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE())),
       (@UserEmId, @Qz3Id, 50.00, 0, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE())), -- Failed attempt
       (@UserEmId, @Qz3Id, 80.00, 1, DATEADD(minute, 30, DATEADD(day, -1, GETDATE())),
        DATEADD(minute, 35, DATEADD(day, -1, GETDATE())));
-- Passed attempt
...
DECLARE @EnrollHaiC4 INT = (SELECT id
                            FROM enrollments
                            WHERE user_id = @UserHaiId
                              AND course_id = @C4Id);
...
DECLARE @EnrollKhoaC5 INT = (SELECT id
                             FROM enrollments
                             WHERE user_id = @UserKhoaId
                               AND course_id = @C5Id);
...
INSERT INTO lesson_progress (enrollment_id, lesson_id, is_completed, last_accessed)
VALUES (@EnrollKhoaC5, @C5_L1, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollKhoaC5, @C5_L2, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollKhoaC5, @C5_L3, 1, DATEADD(day, -1, GETDATE()));

-- Course 5 Quiz Attempts
INSERT INTO quiz_attempts (user_id, quiz_id, score, is_passed, started_at, submitted_at)
VALUES (@UserKhoaId, @C5_Qz1Id, 90.00, 1, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE())),
...
INSERT INTO enrollments (user_id, course_id, progress_percent, created_at, completed_at)
VALUES (@UserLongId, @C1Id, 100.00, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE())),
       (@UserLongId, @C5Id, 100.00, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE()));

DECLARE @EnrollLongC1 INT = (SELECT id
                             FROM enrollments
                             WHERE user_id = @UserLongId
                               AND course_id = @C1Id);
DECLARE @EnrollLongC5 INT = (SELECT id
                             FROM enrollments
                             WHERE user_id = @UserLongId
                               AND course_id = @C5Id);
...
-- Course 1 Lesson Progress (4/4 lessons)
INSERT INTO lesson_progress (enrollment_id, lesson_id, is_completed, last_accessed)
VALUES (@EnrollLongC1, @L1Id, 1, DATEADD(day, -1, GETDATE())),
...
INSERT INTO lesson_progress (enrollment_id, lesson_id, is_completed, last_accessed)
VALUES (@EnrollLongC5, @C5_L1, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollLongC5, @C5_L2, 1, DATEADD(day, -1, GETDATE())),
       (@EnrollLongC5, @C5_L3, 1, DATEADD(day, -1, GETDATE()));

-- Quiz Attempts (Course 1 and Course 5)
INSERT INTO quiz_attempts (user_id, quiz_id, score, is_passed, started_at, submitted_at)
VALUES (@UserLongId, @Qz2Id, 100.00, 1, DATEADD(day, -1, GETDATE()), DATEADD(day, -1, GETDATE())),
...
(@UserAnId, @C1Id, 5, N'Khóa học C cơ bản vô cùng chất lượng, giảng viên giải thích cực kỳ tỉ mỉ và dễ nhớ!', 'VISIBLE',
 DATEADD(day, -3, GETDATE())),
(@UserBinhId, @C1Id, 4,
 N'Bài giảng chuẩn bị rất công phu, giao diện học tập trực quan. Tuy nhiên, một số bài tập tự luyện hơi khó.',
 'VISIBLE', DATEADD(day, -3, GETDATE())),
(@UserLongId, @C1Id, 1, N'Chất lượng âm thanh video bài 2 và bài 3 mờ nhạt và rất khó nghe, mong admin sớm cải thiện.',
 'VISIBLE', DATEADD(day, -1, GETDATE())),

-- Course 2 Feedbacks (Avg = 4.7)
(@UserCuongId, @C2Id, 5, N'Tài liệu PDF đi kèm rất xịn, bài tập trắc nghiệm có giải thích chi tiết đáp án.', 'VISIBLE',
 DATEADD(day, -2, GETDATE())),
...
(@UserDungId, @C3Id, 5, N'Lập trình C thực hành rất thực tế, nhiều bài tập hay.', 'VISIBLE',
 DATEADD(day, -1, GETDATE())),
...
(@UserCuongId, @C4Id, 3, N'Thuật toán C hơi phức tạp so với trình độ của tôi, bài giảng đi nhanh quá.', 'VISIBLE',
 DATEADD(day, -1, GETDATE())),
(@UserAnId, @C4Id, 3, N'Nội dung tạm ổn.', 'VISIBLE', DATEADD(day, -1, GETDATE())),

-- Course 5 Feedbacks (Avg = 3.7)
(@UserKhoaId, @C5Id, 5, N'Khóa học chuyên đề rất hữu ích, giúp tôi hiểu sâu về mảng và con trỏ!', 'VISIBLE',
 DATEADD(day, -1, GETDATE())),
...
INSERT INTO lesson_progress (enrollment_id,
                             lesson_id,
                             is_completed,
                             last_accessed)
